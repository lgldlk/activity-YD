<template>
  <div class="coverage" @click="editCancel">
    <draggable 
    v-model="templateLists" 
    @start="onStart" 
    @end="onEnd"
     animation="300"
     :move="onMove"
    >
    <transition-group>
     <div class="item" v-for="element in templateLists" 
     ...
     <a-icon :type="element.isShow?'eye':'eye-invisible'" @click.stop="switchShow(element.activityId)"/>
        </div>
